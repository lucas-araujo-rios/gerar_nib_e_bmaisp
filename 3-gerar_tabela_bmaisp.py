...
# exporta excel
destino_arquivo = f'embrapii_portfolio_projetos_brasilmaisprodutivo_{recorte[1].strftime('%Y.%m.%d')}.xlsx'
...
# reporta sucesso
print(f'Planilha filtrada do B+P exportada com sucesso para o caminho:\n{destino_arquivo}.')
